...
ActiveRecord::Schema[7.0].define(version: 2023_09_13_100402) do
  ...
  create_table "category_transactions", force: :cascade do |t|
    ...
    t.index ["expense_id"], name: "index_category_transactions_on_expense_id"
  end
  ...
  add_foreign_key "category_transactions", "transactions", column: "expense_id"
